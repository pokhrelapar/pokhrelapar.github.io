...
This page showcases a collection of **coding projects, experiments, and assignments** from my CSE 6363 (Machine Learning) class under [Dr. Alexander Dillhoff](https://ajdillhoff.github.io/). The projects focus on applying ML concepts to real-world datasets and problems using Python, PyTorch, and scikit-learn.  

### Project Page
You can find the GitHub repository here [here](https://github.com/pokhrelapar/CSE-6363_ML).
